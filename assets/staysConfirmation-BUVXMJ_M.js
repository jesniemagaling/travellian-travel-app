import"./swiper-DolsZaOw.js";/* empty css               *//* empty css                     *//* empty css                     */import{s,r as n}from"./stays-BfrsDapl.js";import{a as i,i as c,c as l}from"./nav-BUibuh3s.js";const d="/travellian-travel-app/assets";document.addEventListener("DOMContentLoaded",()=>{i(),c(),l({activeTab:document.querySelector(".stays-btn"),inactiveTab:document.querySelector(".flights-btn")});const{stayId:e,roomId:o}=m(),t=s.find(r=>r.id===e),a=n.find(r=>r.id===o);!t||!a||f(t,a)});function m(){const e=new URLSearchParams(window.location.search);return{stayId:e.get("stay"),roomId:e.get("room")}}function f(e,o){const t=document.querySelector(".hotel-details-wrapper");t&&(t.querySelector(".hotel-details-heading").innerHTML=`
