import"./swiper-DolsZaOw.js";import{a as s,i as n,c as i}from"./nav-BRbo9wLN.js";/* empty css                     *//* empty css                     */import{s as c,r as l}from"./stays-BfrsDapl.js";const d="/travellian-travel-app/assets";document.addEventListener("DOMContentLoaded",()=>{s(),n(),i({activeTab:document.querySelector(".stays-btn"),inactiveTab:document.querySelector(".flights-btn")});const{stayId:e,roomId:o}=m(),t=c.find(a=>a.id===e),r=l.find(a=>a.id===o);!t||!r||f(t,r)});function m(){const e=new URLSearchParams(window.location.search);return{stayId:e.get("stay"),roomId:e.get("room")}}function f(e,o){const t=document.querySelector(".hotel-details-wrapper");t&&(t.querySelector(".hotel-details-heading").innerHTML=`
