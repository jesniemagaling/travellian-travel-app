import"./swiper-DolsZaOw.js";import{a as $,i as k,c as x}from"./styles-CO8zrl36.js";/* empty css                      *//* empty css                      */import{f as L}from"./flights-Bw2lqAzd.js";const a="/travellian-travel-app/assets";document.addEventListener("DOMContentLoaded",()=>{$(),k(),x({activeTab:document.querySelector(".flights-btn"),inactiveTab:document.querySelector(".stays-btn")});const e=S(),t=L.find(s=>s.id===e);t?F(t):console.warn("Flight not found")});function S(){return new URLSearchParams(window.location.search).get("flight")}function F(e){const t=document.querySelector(".flight-booking-payment"),s=e.departures?.[0];if(!t||!s)return;const[g,u]=s.time.split(" - "),[b,w]=s.route.split("-"),n=e.price,r=20,c=10,d=n+r+c;t.innerHTML=`
