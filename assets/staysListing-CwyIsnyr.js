import"./swiper-DolsZaOw.js";import{a as l,i as d,c as m}from"./nav-BRbo9wLN.js";/* empty css                     */import{r as u}from"./stayForm-BQbN_MYX.js";import{s as c}from"./stays-BfrsDapl.js";const i="/travellian-travel-app/assets";document.addEventListener("DOMContentLoaded",()=>{l(),d(),m({activeTab:document.querySelector(".stays-btn"),inactiveTab:document.querySelector(".flights-btn")}),u(),o();const e=document.querySelectorAll(".box");e.forEach(a=>a.addEventListener("click",s=>{s.stopPropagation(),e.forEach(t=>{t!==a&&t.classList.remove("active")}),a.classList.toggle("active")})),document.addEventListener("click",()=>{e.forEach(a=>a.classList.remove("active"))})});function o(){const e=document.getElementById("stayCardContainer");if(!e)return;const a=v(c,r),s=f(a,r.sort);e.innerHTML=s.map(t=>`
