import"./swiper-DZbraFs1.js";import{s as p,r as y}from"./stays-BfrsDapl.js";import{g as b}from"./staysdetails-slZo-5Hr.js";import"./nav-BUibuh3s.js";const g="/travellian-travel-app/assets";document.addEventListener("DOMContentLoaded",()=>{const{stayId:e,roomId:t}=v(),o=p.find(n=>n.id===e),s=y.find(n=>n.id===t);!o||!s||$(o,s)});function v(){const e=new URLSearchParams(window.location.search);return{stayId:e.get("stay"),roomId:e.get("room")}}function $(e,t){const o=document.querySelector(".hotel-booking-payment"),s=document.querySelector(".booking-total-container");if(!o||!s)return;o.querySelector(".room-details-heading").innerHTML=`
