const i="/travellian-travel-app/assets";function t(){let a="";a+=`
    <!-- Flights Form -->
    ...
    <div class="actions flight-actions">
      ...
      <a href="">
        <button class="inline-flex btn-primary flight-btn">
          <img src="${i}/show-icon.svg" alt="" />&nbsp;Show Flights
        </button>
      </a>
    </div>
  `,document.getElementById("flight-content").innerHTML=a}export{t as r};
